...
function PropertyDetailsPage({
  ...
  return (
    ...
    >
      ...
      {/* Image Section */}
      <div className="w-11/12 md:2 max-w-md mb-4">
        <div className="relative">
          {propertyDetails && !isLoading ? (
            ...
            <Skeleton className="h-80 bg-cvr opacity-20 w-full rounded-2xl" />
          )}
        </div>
      </div>
        ...
        <CardContent className="p-5">
          <div className="flex justify-between items-start mb-3">
            ...
            {propertyDetails?.property_kind && (
              <Badge className="bg-cvr text-white px-3 py-1 text-xs">
                {propertyDetails?.property_kind}
              </Badge>
            )}
          </div>
        ...
        <CardContent className="p-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center gap-3 bg-[#F0F8FF] p-3 rounded-xl">
              <div className="bg-cvr p-2 rounded-lg">
      ...
      {propertyDetails?.social_media && (
        <Card className="bg-white w-11/12 max-w-md rounded-2xl shadow-lg border-none mb-3">
          <CardContent className="p-5">
            ...
            >
              <Badge className="bg-cvr">Google</Badge>

      ...
      <section className="px-6 md:px-20 pt-16 pb-10">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-10">
          ...
          <div className="max-w-2xl">
            <h1 className={`text-4xl md:text-6xl font-bold leading-tight text-gray-900 ${inter.className}`}>
      ...
      <section className="bg-black text-white mt-10 py-12">
        <div className="px-6 md:px-20 grid grid-cols-2 md:grid-cols-4 gap-10 text-center">
          ...
          <div>
            ...
            <p className="text-gray-400 mt-2">Properties Sold</p>
          </div>
